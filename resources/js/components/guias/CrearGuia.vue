<template>
    <v-container>
        <div class="contenido mx-2 d-flex" v-if="$gate.isAdmin()">
            <v-btn            
                fab
                dark
                color="indigo" 
            ...
            <p class="titulo-seccion align-center" style="margin-top: 15px; margin-left: 10px;">Añadir Guia</p>
        </div>
        ...
        <div class="foros contenido">
            ...
            >   
                ...
                <router-link :to="`/crearPasos?guia=${guia.id}`" class="linkComentarios">
                    <v-row
                        align="center"
